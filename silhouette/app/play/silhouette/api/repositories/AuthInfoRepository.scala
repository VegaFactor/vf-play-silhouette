 ...
 */
package play.silhouette.api.repositories
...
trait AuthInfoRepository {
   ...
   */
  def add[T <: AuthInfo](loginInfo: LoginInfo, authInfo: T)(implicit request: RequestHeader): Future[T]
   ...
   */
  def update[T <: AuthInfo](loginInfo: LoginInfo, authInfo: T)(implicit request: RequestHeader): Future[T]
   ...
   * @return The updated auth info.
   */
  def save[T <: AuthInfo](loginInfo: LoginInfo, authInfo: T)(implicit request: RequestHeader): Future[T]
   ...
   */
  def remove[T <: AuthInfo](loginInfo: LoginInfo)(implicit request: RequestHeader, tag: ClassTag[T]): Future[Unit]
}
